        ...
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          <div className="flex items-center space-x-4">
            ...
            <a
              ...
              className="group flex items-center space-x-2 px-3 py-2 bg-gradient-to-r from-purple-500/10 to-pink-500/10 border border-purple-500/20 rounded-xl hover:from-purple-500/20 hover:to-pink-500/20 hover:border-purple-500/30 transition-all duration-200 hover:shadow-lg hover:shadow-purple-500/10 hover:scale-105"
